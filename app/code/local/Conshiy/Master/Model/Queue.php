 ...
 */
class Conshiy_Master_Model_Queue extends Mage_Core_Model_Abstract
{

	protected function _construct()
	{
		$this->_init('conshiymaster/queue');
	}
	...
	{
		return $this->_getResource()->getUniqueQueue($resourceModel, $resourceIdentifier, $slaveId);
	}
